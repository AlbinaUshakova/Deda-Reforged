...
export const PHRASES_EPISODE: Episode = {
  ...
  cards: [
    ...
    phrase('კარგად იყავი', 'Пока', 'Неформально → одному человеку на “ты”.', ['Будь здоров', 'Будь здорова']),
    phrase('კარგად ბრძანდებოდეთ', 'До свидания', 'Вежливо → одному человеку или группе на “вы”.', ['Всего доброго']),
    ...
    phrase('უკაცრავად', 'Извините', 'Удобно, когда нужно привлечь внимание или пройти.', ['Простите', 'Извини', 'Прости']),
    phrase('მაპატიეთ', 'Простите', undefined, ['Извините', 'Извини', 'Прости']),
    phrase('არაუშავს', 'Ничего страшного', undefined, ['Все нормально', 'Ничего', 'Все хорошо', 'Нормально']),
    ...
    phrase('კარგია', 'Хорошо', undefined, ['Это хорошо', 'Нормально', 'Это нормально']),
    ...
    phrase('როგორ მივიდე ...მდე?', 'Как добраться до ...?', 'Грамматика → -მდე значит “до”.', undefined, false),
    ...
    phrase('ერთი, თუ შეიძლება', 'Один, пожалуйста', undefined, ['Одну пожалуйста']),
    phrase('ორი, თუ შეიძლება', 'Два, пожалуйста', undefined, ['Две пожалуйста']),
